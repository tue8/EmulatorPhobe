...
/* written by javidx09 not by me lol */
...
uint8_t Cpu::PHA()
{
	...
	// 0x0100 is 6502 stack's base location
	write(0x0100 + stkp, a);
	stkp--;
	return 0;
}
...
void Cpu::reset()
{
	...
	// intial pc value at this address
	// initial pc value isn't at 0x0000 since the zeroth page is where
	// the user programmable things reside, and the stack is at 0x0100
	addr_abs = 0xFFFC;
